...
python train.py --exp_name our+_bs32_kl0.001_pos1_col0_theta1_size1_ref0.1_ep1500 --config /data/eperuzzo/brushstrokes-generation/configs/train/conf2.yaml & wait