...
python train.py --exp_name our_bs32_kl0.0025_pos1_col1_theta1_size1_ref0.1_ep2000 --config /data/eperuzzo/brushstrokes-generation/configs/train/conf2.yaml & wait