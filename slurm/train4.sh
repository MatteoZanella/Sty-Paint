...
python train.py --exp_name our+_bs32_kl0.001_n16_pos1_col0_theta1_size1_ref0.1 --config /data/eperuzzo/brushstrokes-generation/configs/train/conf4.yaml & wait