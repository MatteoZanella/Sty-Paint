...
python train.py --exp_name our_bs32_ntk16_kl0.001_pos1_col1_theta1_size1_ref0.1 --config /data/eperuzzo/brushstrokes-generation/configs/train/conf9.yaml & wait